...
class MenuItemSearchTile extends StatefulWidget {
  ...
  const MenuItemSearchTile(
      this.menuItem, this.restaurant, this.avgRating, this.milesAway, this.id);
    ...
    return Container(
        ...
        child: Column(children: <Widget>[
            ...
            Container(
              child: Row(
                children: [
                  ...
                  SizedBox(width: 5),
                  Text(avgRating == null ? "0" : avgRating.toStringAsFixed(1),
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                      )),
          ...
          Row(children: [
            ...
            Container(
                child: milesAway == null
                    ? null
                    : Text(milesAway.toStringAsFixed(2) + " mi",
